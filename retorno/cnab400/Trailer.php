...
class Cnab_Retorno_Cnab400_Trailer extends Cnab_Format_Linha
{
	public $fieldsGroup;
	...
	public function __construct($codigo_banco)
	{
		if(Cnab_Banco::ITAU == $codigo_banco)	
			$this->fieldsGroup = new Cnab_Retorno_Cnab400_Trailer_ItauFields($this);
		else if(Cnab_Banco::CEF == $codigo_banco)
			$this->fieldsGroup = new Cnab_Retorno_Cnab400_Trailer_CefFields($this);
...
class Cnab_Retorno_Cnab400_Trailer_BaseFields
{
	public $detalhe;
	...
	public function decorate()
	{
		...
		$this->detalhe->addField('codigo_do_banco',          5,    7, '9(03)',                false/*'341'*/); // Identificação Do Banco Na Compensação

		$this->detalhe->addField('numero_sequencial',      395,  400, '9(06)',                false); // Número Seqüencial Do Registro No Arquivo
	}
}

class Cnab_Retorno_Cnab400_Trailer_ItauFields extends Cnab_Retorno_Cnab400_Trailer_BaseFields
{
	public function decorate()
	{
...
class Cnab_Retorno_Cnab400_Trailer_CefFields extends Cnab_Retorno_Cnab400_Trailer_BaseFields
{
	public function decorate()
	{
