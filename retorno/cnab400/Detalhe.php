...
require_once dirname(__FILE__).'/../IDetalhe.php';

class Cnab_Retorno_Cnab400_Detalhe extends Cnab_Format_Linha implements Cnab_Retorno_IDetalhe
{
	public $fieldsGroup;
	...
	public function __construct($codigo_banco)
	{
		...
		if(Cnab_Banco::CEF == $codigo_banco)
			$this->fieldsGroup = new Cnab_Retorno_Cnab400_Detalhe_CefFields($this);
		else if (Cnab_Banco::ITAU == $codigo_banco)
			$this->fieldsGroup = new Cnab_Retorno_Cnab400_Detalhe_ItauFields($this);
	...
	{
		if(Cnab_Banco::CEF == $this->_codigo_banco)
			return 0;
		else
...
class Cnab_Retorno_Cnab400_Detalhe_BaseFields
{
	public $detalhe;
...
class Cnab_Retorno_Cnab400_Detalhe_ItauFields extends Cnab_Retorno_Cnab400_Detalhe_BaseFields
{
	public function decorate()
	{
...
class Cnab_Retorno_Cnab400_Detalhe_CefFields extends Cnab_Retorno_Cnab400_Detalhe_BaseFields
{
	public function decorate()
	{
