...
class Cnab_Remessa_Cnab400_Arquivo implements Cnab_Remessa_IArquivo
{
	public  $header;
	public  $trailer;
	...
	public function __construct($codigo_banco)
	{
        ...
        $this->banco  = Cnab_Banco::getBanco($this->codigo_banco);
	...
	public function configure(array $params)
	{
        ...
        $this->header = new Cnab_Remessa_Cnab400_Header($this);
    ...
    public function insertDetalhe(array $boleto, $tipo='remessa')
    {
        ...
        $detalhe = new Cnab_Remessa_Cnab400_Detalhe($this);
	...
	public function getText()
	{
		...
		$this->trailer = new Cnab_Remessa_Cnab400_Trailer($this);
