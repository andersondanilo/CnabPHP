...
class Arquivo implements \Cnab\Remessa\IArquivo
{
	...
	public function configure(array $params)
	{
        ...
        else
        {
            ...
            $this->header->conta_dv = $this->configuracao['conta_dv'];
        }
    ...
    public function insertDetalhe(array $boleto, $tipo='remessa')
    {
        ...
        if($tipo == 'remessa')
        {
            ...
            if(\Cnab\Banco::CEF == $this->codigo_banco)
            {
                ...
                $detalhe->taxa_permanencia = $boleto['taxa_permanencia'];
            ...
            */
            ...
            $detalhe->aceite =   'N';
            //$detalhe->instrucao1 = !empty($boleto['instrucao1']) ? $boleto['instrucao1'] : '';
            //$detalhe->instrucao2 = !empty($boleto['instrucao2']) ? $boleto['instrucao2'] : '';
        ...
        else if($tipo == 'baixa')
        {
            ...
            */
            ...
            $detalhe->juros_um_dia = $boleto['juros_um_dia'];
