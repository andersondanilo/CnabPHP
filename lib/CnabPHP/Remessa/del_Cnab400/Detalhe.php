...
class Detalhe extends \Cnab\Format\Linha
{
	...
	public function __construct(\Cnab\Remessa\IArquivo $arquivo)
	{
		...
		if(\Cnab\Banco::ITAU == $codigo_banco)
			$this->fieldsGroup = new ItauFields($this);
		else if(\Cnab\Banco::CEF == $codigo_banco)
			$this->fieldsGroup = new CefFields($this);
...
class CefFields extends BaseFields
{
	public function addFields()
	{
		$banco = \Cnab\Banco::getBanco(Cnab_Banco::CEF);
		// Cnab_Banco::CEF
